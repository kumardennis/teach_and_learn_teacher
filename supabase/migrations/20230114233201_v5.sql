...
create table "public"."Lessons_LessonScheduleTimes" (
    "id" uuid not null default uuid_generate_v4(),
    "created_at" timestamp with time zone default now(),
    "scheduleTimeId" uuid,
    "lessonId" uuid
...
alter table "public"."Lessons_LessonScheduleTimes" enable row level security;
...
CREATE UNIQUE INDEX "Lessons_LessonScheduleTimes_pkey" ON public."Lessons_LessonScheduleTimes" USING btree (id);
...
alter table "public"."Lessons_LessonScheduleTimes" add constraint "Lessons_LessonScheduleTimes_pkey" PRIMARY KEY using index "Lessons_LessonScheduleTimes_pkey";
...
alter table "public"."Lessons" add constraint "Lessons_addressId_fkey" FOREIGN KEY ("addressId") REFERENCES "Addresses"(id) not valid;

alter table "public"."Lessons" validate constraint "Lessons_addressId_fkey";
...
alter table "public"."Lessons_LessonScheduleTimes" add constraint "Lessons_LessonScheduleTimes_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "Lessons"(id) not valid;

alter table "public"."Lessons_LessonScheduleTimes" validate constraint "Lessons_LessonScheduleTimes_lessonId_fkey";

alter table "public"."Lessons_LessonScheduleTimes" add constraint "Lessons_LessonScheduleTimes_scheduleTimeId_fkey" FOREIGN KEY ("scheduleTimeId") REFERENCES "LessonScheduleTimes"(id) not valid;

alter table "public"."Lessons_LessonScheduleTimes" validate constraint "Lessons_LessonScheduleTimes_scheduleTimeId_fkey";
...
alter table "public"."Students" add constraint "Students_userId_fkey" FOREIGN KEY ("userId") REFERENCES auth.users(id) not valid;
