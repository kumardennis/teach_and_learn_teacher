...
class AddIndividualSchedule extends HookWidget {
  AddIndividualSchedule({Key? key}) : super(key: key);
    ...
    Future<void> createTeacherSchedule() async {
      ...
      try {
        final response = await Supabase.instance.client.functions
          ...
          "addressIds": selectedAddresses.value
        });
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: MultiSelectBottomSheetField(
                decoration: BoxDecoration(
                  border: Border.all(color: Theme.of(context).colorScheme.snow),
                ),
                buttonText: Text(
                  'lbl_SelectAddresses'.tr,
                  style: Theme.of(context)
                      .textTheme
                      .titleLarge
                ...
                backgroundColor: Theme.of(context).colorScheme.snow,
                checkColor: Theme.of(context).colorScheme.snow,
                selectedColor: Theme.of(context).colorScheme.blue,
                unselectedColor: Theme.of(context).colorScheme.lineColor,
                isDismissible: false,
                confirmText: Text(
                  'lbl_Ok'.tr,
                  style: Theme.of(context)
                ...
                items: addresses.value
                    .map((address) => MultiSelectItem<String>(
                        address.Addresses.id, address.Addresses.name))
                    .toList(),
                onConfirm: (values) {
                  selectedAddresses.value = values;
                },
                chipDisplay: MultiSelectChipDisplay(
                  chipColor: Theme.of(context).colorScheme.blue,
                  textStyle: Theme.of(context)
                      .textTheme
                      .bodyMedium
                      ?.copyWith(color: Theme.of(context).colorScheme.snow),
                ),
              ),
            ),
          ),
